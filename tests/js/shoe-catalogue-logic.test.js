    ...
    describe('Shoe Catalogue Filter', function(){
        ...
        describe('Filter with Color', function(){
            it('Should get all shoes that are red', function(){
                var array = [{ _id:5, qty:0, total:0, brand: "Puma", size:10, color:"Red",  img: "https://pbs.twimg.com/media/EV1ZD0IWoAEO3Ci.jpg", price:1100, in_stock:1, prc:1100}, 
                { _id:9, qty:0, total:0, brand: "All-Star", size:7, color:"Red",  img: "https://footwearnews.com/wp-content/uploads/2019/02/converse.jpg", price: 800, in_stock:50, prc:800}, 
        ...
        describe("Filter with size and color", function(){
            it('Should get all white shoes that are size 2', function(){
                var array = [
                    { _id:7, qty:0, total:0, brand: "All-Star", size:2, color:"White",  img: "https://images.asos-media.com/products/converse-chuck-taylor-all-star-ox-white-sneakers/12649327-1-opticalwhite?$XXL$&wid=513&fit=constrain", price:400, in_stock:25, prc:400}, 
                    { _id:11, qty:0, total:0, brand: "Vans", size:2, color:"White",  img: "https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/how-to-clean-vans-shoes-1558648863.png", price:550, in_stock:5, prc:550}, 
                ]
                assert.deepEqual(array, init.shoesFilterFunction({color: "White", size: 2}))
            })
            it('Should get all red shoes that are size 6', function(){
                var array = [
                    { _id:19, qty:0, total:0, brand: "Vans", size:6, color:"Red",  img: "https://i.pinimg.com/originals/5f/b7/0c/5fb70c32d8d5860a5efd45dfa0387e38.jpg", price:760, in_stock:20, prc:760}, 
                ]
                assert.deepEqual(array, init.shoesFilterFunction({color: "Red", size: 6}))
            })
            it('Should get all black shoes that are size 10', function(){
                var array = [
                    { _id:1,qty:0, total:0, brand: "Vans", size:10, color:"Black",  img: "https://thumbs.dreamstime.com/b/brand-new-black-white-vans-old-skool-shoes-box-pavia-italy-november-brand-new-black-white-vans-old-skool-shoes-168876419.jpg", price:800, in_stock:10,  prc: 800}, 
                ]
                assert.deepEqual(array, init.shoesFilterFunction({color: "Black", size: 10}))
            })
        })

        describe("Filter with size and color and brand", function(){
            it('Should get all vans that are size 10 and black', function(){
                var array = [
                    { _id:1,qty:0, total:0, brand: "Vans", size:10, color:"Black",  img: "https://thumbs.dreamstime.com/b/brand-new-black-white-vans-old-skool-shoes-box-pavia-italy-november-brand-new-black-white-vans-old-skool-shoes-168876419.jpg", price:800, in_stock:10,  prc: 800}, 
                ]
                assert.deepEqual(array, init.shoesFilterFunction({color: "Black", size: 10, brand: "Vans"}))
            })
            it('Should get all Puma that are size 9 and white', function(){
                var array = [
                    { _id:20, qty:0, total:0, brand: "Puma", size:9, color:"White",  img: "https://www.mixerfoodepizza.com/images/k/puma%20cali%20women-167hlr.jpg", price:1000, in_stock:9, prc:1000}
                ]
                assert.deepEqual(array, init.shoesFilterFunction({color: "White", size: 9, brand: "Puma"}))
            })

            it('Should get all Nikes that are size 10 and Grey', function(){
                var array = [
                ...
                assert.deepEqual(array, init.shoesFilterFunction({color: "Grey", size: 10, brand: "Nike"}))
            })
        })
